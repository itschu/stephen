		...
		<div id="footer" className="py-5 px-6 md:px-10 h-fit">
			<div className="flex gap-5 md:gap-20 items-center justify-between flex-col md:flex-row">
				<div className="flex gap-5 md:gap-14 items-center flex-col md:flex-row">
					<div className="bg-neutral-300 h-28 w-28 rounded-full"></div>

					<a className="flex gap-2 items-center text-base">
						<svg
					...
					<a className="flex gap-2 items-center text-base">
						...
						<span>support@stephenware.com</span>
					</a>
				</div>
				...
				<div className="flex gap-5 mt-6 md:mt-0">
					<Link href={""}>
						<p className="relative w-5 h-5 md:w-6 md:h-6">
							<Image src={"/facebook-black.png"} layout="fill" />
						</p>
					</Link>

					<Link href={""}>
						<p className="relative w-5 h-5 md:w-6 md:h-6">
							<Image src={"/twitter-black.png"} layout="fill" />
						</p>
					</Link>

					<Link href={""}>
						<p className="relative w-5 h-5 md:w-6 md:h-6">
							<Image src={"/instagram-black.png"} layout="fill" />
						</p>
					</Link>
				</div>
			</div>
			...
			<p className="mt-5 md:mt-0 text-sm text-center md:text-right">
				stephenware.com Copyright © 2022
			</p>
		</div>
	);
};
